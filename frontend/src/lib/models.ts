...
const STATIC_FALLBACK: CatalogModel[] = [
  { id: "claude-sonnet-4-6", name: "Claude Sonnet 4.6", alias: "sonnet", hint: "Balanced", provider: "claude", cost: { input_per_m: 3, output_per_m: 15 }, context_window: 1_000_000, speed_tier: "medium", capabilities: { can_generate_images: false, has_vision: true, can_edit_images: false, has_thinking: true, supports_pdf: true, supports_audio: false, supports_tool_execution: true, supports_verbosity: false, supports_xhigh: false, supports_session_cache: false, max_output_tokens: 16384 } },
  { id: "claude-opus-4-6", name: "Claude Opus 4.6", alias: "opus", hint: "Powerful", provider: "claude", cost: { input_per_m: 5, output_per_m: 25 }, context_window: 1_000_000, speed_tier: "slow", capabilities: { can_generate_images: false, has_vision: true, can_edit_images: false, has_thinking: true, supports_pdf: true, supports_audio: false, supports_tool_execution: true, supports_verbosity: false, supports_xhigh: false, supports_session_cache: false, max_output_tokens: 32768 } },
  { id: "claude-haiku-4-5", name: "Claude Haiku 4.5", alias: "haiku", hint: "Quick", provider: "claude", cost: { input_per_m: 1, output_per_m: 5 }, context_window: 200_000, speed_tier: "fast", capabilities: { can_generate_images: false, has_vision: true, can_edit_images: false, has_thinking: false, supports_pdf: true, supports_audio: false, supports_tool_execution: true, supports_verbosity: false, supports_xhigh: false, supports_session_cache: false, max_output_tokens: 8192 } },
  { id: "gemini-3-flash-preview", name: "Gemini 3 Flash", alias: "flash", hint: "Fast", provider: "gemini", cost: { input_per_m: 0.5, output_per_m: 3 }, context_window: 1_000_000, speed_tier: "fast", capabilities: { can_generate_images: true, has_vision: true, can_edit_images: true, has_thinking: true, supports_pdf: true, supports_audio: true, supports_tool_execution: true, supports_verbosity: false, supports_xhigh: false, supports_session_cache: false, max_output_tokens: 65536 } },
  { id: "gemini-3.1-flash-lite-preview", name: "Gemini 3.1 Flash Lite", alias: "3.1-flash-lite", hint: "High Throughput", provider: "gemini", cost: { input_per_m: 0.1, output_per_m: 0.4 }, context_window: 1_000_000, speed_tier: "fast", capabilities: { can_generate_images: false, has_vision: true, can_edit_images: false, has_thinking: false, supports_pdf: true, supports_audio: false, supports_tool_execution: false, supports_verbosity: false, supports_xhigh: false, supports_session_cache: false, max_output_tokens: 8192 } },
  { id: "gemini-3.1-pro-preview", name: "Gemini 3.1 Pro", alias: "3.1-pro", hint: "Deep Reasoning", provider: "gemini", cost: { input_per_m: 3, output_per_m: 15 }, context_window: 1_000_000, speed_tier: "slow", capabilities: { can_generate_images: false, has_vision: true, can_edit_images: false, has_thinking: true, supports_pdf: true, supports_audio: false, supports_tool_execution: true, supports_verbosity: false, supports_xhigh: false, supports_session_cache: false, max_output_tokens: 65536 } },
  { id: "codex/gpt-5.4", name: "GPT-5.4 (Codex)", alias: "codex-5.4", hint: "Frontier", provider: "codex", cost: { input_per_m: 2.5, output_per_m: 15 }, context_window: 1_050_000, speed_tier: "medium", capabilities: { can_generate_images: false, has_vision: true, can_edit_images: false, has_thinking: true, supports_pdf: true, supports_audio: false, supports_tool_execution: true, supports_verbosity: true, supports_xhigh: true, supports_session_cache: true, max_output_tokens: 32768 } },
  { id: "codex/gpt-5.3-codex", name: "GPT-5.3 Codex", alias: "codex", hint: "Best Coding", provider: "codex", cost: { input_per_m: 1.75, output_per_m: 14 }, context_window: 400_000, speed_tier: "fast", capabilities: { can_generate_images: false, has_vision: true, can_edit_images: false, has_thinking: true, supports_pdf: false, supports_audio: false, supports_tool_execution: true, supports_verbosity: true, supports_xhigh: false, supports_session_cache: true, max_output_tokens: 32768 } },
  { id: "codex/gpt-5.3-codex-spark", name: "GPT-5.3 Codex Spark", alias: "codex-spark", hint: "Real-Time Coding", provider: "codex", cost: { input_per_m: 1, output_per_m: 8 }, context_window: 400_000, speed_tier: "fast", capabilities: { can_generate_images: false, has_vision: true, can_edit_images: false, has_thinking: true, supports_pdf: false, supports_audio: false, supports_tool_execution: true, supports_verbosity: true, supports_xhigh: false, supports_session_cache: true, max_output_tokens: 16384 } },
  { id: "codex/gpt-5.2-codex", name: "GPT-5.2 Codex", alias: "codex-5.2", hint: "Coding Stable", provider: "codex", cost: { input_per_m: 2, output_per_m: 12 }, context_window: 400_000, speed_tier: "medium", capabilities: { can_generate_images: false, has_vision: true, can_edit_images: false, has_thinking: true, supports_pdf: false, supports_audio: false, supports_tool_execution: true, supports_verbosity: true, supports_xhigh: false, supports_session_cache: true, max_output_tokens: 32768 } },
];
