...
export function SessionTableRow({
  ...
  const descriptionTitle = getSessionDescriptionTitle(session)
  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          'grid cursor-pointer grid-cols-[56px_minmax(120px,0.55fr)_minmax(280px,1.6fr)_minmax(360px,1.45fr)_72px_64px] items-center gap-3 px-4 py-2 transition-colors',
      ...
      >
        ...
        <div className="min-w-0">
          <span
            className="block truncate text-sm text-slate-200"
            title={descriptionTitle || session.id}
          >
            {description}
          </span>
        ...
        <div className="min-w-0 space-y-1">
          ...
          <div className="flex min-w-0 items-center gap-2 text-[11px] text-slate-500">
            ...
            <Tooltip
              content={
                <div className="space-y-0.5 text-[11px]">
                  ...
                  <div>Total: {usageCopy.secondary}</div>
                  {hasSettledZeroUsage ? (
                    <div className="text-slate-400">Recorded zero usage</div>
                  ) : null}
                </div>
              }
              position="top"
            >
              <span
                className={cn(
                  'cursor-help truncate font-mono tabular-nums',
            ...
            <div className="sr-only" title={modelTitle}>
              {modelTitle}
            </div>
          </div>
        </div>
