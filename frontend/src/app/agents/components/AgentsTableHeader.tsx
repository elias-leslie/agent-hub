import { Activity, Clock, CheckCircle2, Code, Timer } from "lucide-react";
...
export function AgentsTableHeader({
  ...
  return (
    <div className="bg-slate-50/95 dark:bg-slate-800/95 border-b border-slate-200 dark:border-slate-700 min-w-[1250px]">
      <div className="grid grid-cols-[180px_1fr_100px_70px_70px_130px_130px_130px_80px_40px] gap-3 px-4 py-2.5 items-center">
