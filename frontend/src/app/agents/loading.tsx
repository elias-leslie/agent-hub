  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <main className="px-6 lg:px-8 py-5">
        ...
        <div className="mb-5 p-4 rounded-lg border border-slate-800 bg-slate-900">
        ...
        <div className="bg-slate-900 rounded-lg border border-slate-800 overflow-hidden shadow-sm">
          ...
          {Array.from({ length: 5 }).map((_, i) => (
            <div
              key={i}
              className="grid grid-cols-[180px_1fr_100px_70px_130px_130px_130px_80px_40px] gap-3 px-4 py-3 border-b border-slate-800/50"
            >
              ...
              <div className="h-4 w-12 rounded bg-slate-700 animate-pulse" />
              <div className="h-4 w-12 rounded bg-slate-700 animate-pulse" />
              <div className="h-4 w-8 rounded bg-slate-700 animate-pulse" />
