      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="rounded-lg border border-slate-200 px-3 py-1.5 text-xs font-medium text-slate-700 transition border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800"
          >
      ...
      {previewMode !== "heartbeat" ? (
        <label htmlFor={promptInputId} className="space-y-1.5">
          ...
          <textarea
            ...
            className="min-h-[96px] w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none transition border-slate-700 dark:bg-slate-950"
          />
        ...
        <div className="rounded-lg border border-dashed border-slate-300 px-3 py-2 text-[11px] text-slate-500 dark:border-slate-700 dark:text-slate-400">
