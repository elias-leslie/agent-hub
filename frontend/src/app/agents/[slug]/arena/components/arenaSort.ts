...
export function sortSuites(suites: AgentBenchmarkSuiteSummary[]) {
  return [...suites].sort((a, b) => {
    if (b.open_regressions !== a.open_regressions) return b.open_regressions - a.open_regressions;
    if ((a.avg_score ?? 999) !== (b.avg_score ?? 999)) return (a.avg_score ?? 999) - (b.avg_score ?? 999);
