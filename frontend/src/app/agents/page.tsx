...
import { fetchAgentMetrics, fetchAgents } from '@/lib/api'
...
export default function AgentsPage() {
  ...
  const catalogAgents =
    data?.agents?.filter((agent) => agent.slug !== 'persona') ?? []
            ...
            <div className="page-title-group">
              ...
              <div className="page-title-stack">
                ...
                <div className="page-meta">
                  <span>
                    Manage active agents, compare runtime behavior, and shape
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-amber-200/80">
                    This deactivates the agent and removes it from the default
                    list. You can still find it later by showing inactive
                    agents.
                  </p>
                </div>
              </div>
