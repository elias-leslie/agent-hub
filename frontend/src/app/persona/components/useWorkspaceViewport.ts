...
interface UseWorkspaceViewportOptions {
  ...
  setFirstUnreadItemId: (updater: (current: string | null) => string | null) => void;
}
...
export function useWorkspaceViewport({
  ...
  }, [anchorEntryId, autoFollow, clearInitialViewportTimeout, deferredSearch, focusSessionId, hydratedEntries.length, loading, messagesLength]);
