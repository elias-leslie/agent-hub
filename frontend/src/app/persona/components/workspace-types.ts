...
import type { PersonaStreamEntry, PersonaStreamEventPreview, PersonaPulseSummary, PersonaIssueMarker } from "@/lib/api/persona-stream";
...
export type FeedMessage = { kind: "message"; id: string; sessionId: string | null; timestamp: Date; message: ChatMessage };
