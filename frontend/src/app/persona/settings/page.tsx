...
export default function PersonaSettingsPage() {
  ...
  const activeTabMeta =
    PERSONA_SETTINGS_TABS.find((tab) => tab.id === activeTab) ??
    PERSONA_SETTINGS_TABS[0]
    ...
    return (
      <div className="flex min-h-screen items-center justify-center px-6">
        <div className="max-w-md text-center space-y-2">
          ...
          <p className="text-sm text-slate-400">{personaError || agentError}</p>
        </div>
      </div>
    )
  }
          ...
          <div className="flex flex-col gap-6 xl:flex-row">
            ...
            <main className="min-w-0 flex-1 overflow-y-auto">
              ...
              <div className="panel-surface mb-4 flex items-center gap-2 px-4 py-3 lg:hidden">
                ...
                {(() => {
                  const currentTab = PERSONA_SETTINGS_TABS.find(
                    (t) => t.id === activeTab,
                  )
                  ...
                  <div className="max-w-5xl">
                    {activeTab === 'identity' && (
                      <IdentityTab
                        ...
                        onPersonaRefresh={refreshPersona}
                      />
                    )}
                    {activeTab === 'models' && (
