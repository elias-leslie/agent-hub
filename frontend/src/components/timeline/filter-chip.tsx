...
export function FilterChip({ label, eventType, isActive, count, compact = false, onClick }: FilterChipProps) {
  ...
  return (
    <button
      ...
      className={cn(
        ...
        compact ? "text-[11px] font-medium tracking-wide" : "text-xs font-medium tracking-wide",
