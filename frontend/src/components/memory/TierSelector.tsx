    ...
    <div className="space-y-2">
      ...
      <div className="relative">
        ...
        >
          ...
          <ChevronDown className={cn("w-4 h-4 ml-auto text-slate-400 transition-transform", isOpen && "rotate-180")} />
        </button>
            ...
            {(["mandate", "guardrail", "reference"] as MemoryCategory[]).map((t) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-xs text-slate-400 ml-1">{TIER_DESCRIPTIONS[t]}</span>
