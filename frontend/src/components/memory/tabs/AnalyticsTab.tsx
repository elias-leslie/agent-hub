...
export function AnalyticsTab() {
  ...
  const { data: analytics, isLoading, error } = useQuery<MemoryAnalyticsDashboard>({
    queryKey: ["memoryAnalytics", lookback, topMemoriesSortBy],
    queryFn: () => fetchMemoryAnalytics({ days: analyticsDays, lookback, sortBy: topMemoriesSortBy }),
    ...QUERY_CONFIG,
  });
