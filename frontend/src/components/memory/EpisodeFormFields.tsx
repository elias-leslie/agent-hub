...
const CONTEXT_KIND_OPTIONS: Array<{
...
}> = [
  {
    value: 'policy',
    label: 'Policy',
    description: 'Hard or soft operating rules.',
  },
  {
    value: 'reference',
    label: 'Reference',
    description: 'Lookup knowledge for selective injection.',
  },
  {
    value: 'capability',
    label: 'Capability',
    description: 'Tool/control-surface catalog entries.',
  },
  {
    value: 'continuity',
    label: 'Continuity',
    description: 'Temporal state and follow-up context.',
  },
  {
    value: 'signal',
    label: 'Signal',
    description: 'Ratings, evidence, and curation signals.',
  },
]
    ...
    <>
      ...
      <div className="space-y-2">
        ...
        <select
          value={contextKind}
          onChange={(e) =>
            onContextKindChange(e.target.value as MemoryContextKind)
          }
          disabled={disabled}
          className={cn(
            'w-full px-3 py-2.5 rounded-lg text-sm',
      ...
      <div className="space-y-3 rounded-lg border border-slate-700/70 bg-slate-900/40 p-4">
        <div>
          <h4 className="text-sm font-medium text-slate-200">Applicability</h4>
          <p className="text-xs text-slate-400">
        ...
        <div className="grid gap-3 md:grid-cols-2">
          <div className="space-y-1.5">
            ...
            <input
              ...
              disabled={disabled}
              placeholder="agent_coding, agent_operator, agent_startup"
