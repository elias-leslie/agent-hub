...
for service in neo4j hatchet-engine agent-hub-backend agent-hub-frontend agent-hub-hatchet-worker; do
    echo "--- ${service} ---"
...
echo "=== Port Check ==="
ss -tlnp 2>/dev/null | grep -E ':800[0-9]|:300[0-9]|:7474|:7687|:8888|:7077' || echo "No relevant ports found"
