...
- Safe cleanup means merged/retired residue only. If cleanup output shows dirty, conflicting, or review-needed worktrees, stop there and reconcile the underlying task/workstream instead of forcing deletion.
