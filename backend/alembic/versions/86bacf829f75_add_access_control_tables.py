...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["client_id"],
            ["clients.id"],
            name="fk_request_logs_clients_client_id",
            ondelete="SET NULL",
        ),
        sa.PrimaryKeyConstraint("id"),
    )
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint("fk_sessions_clients_client_id", "sessions", type_="foreignkey")
    ...
    sa.Enum(name="rejection_reason_enum").drop(op.get_bind(), checkfirst=True)
