...
class TestDetectRequiredCapabilities:
    ...
    def test_image_generation_required(self):
    ...
    def test_image_editing_required(self):
...
class TestSelectModel:
    ...
    def test_tier_1_returns_cheap_model(self):
    ...
    def test_tier_4_returns_advanced_model(self):
    ...
    def test_economy_prefers_cheap(self):
    ...
    def test_advanced_prefers_quality(self):
...
class TestFindEquivalent:
    ...
    def test_find_equivalent_in_different_provider(self):
    ...
    def test_equivalent_has_similar_score(self):
...
class TestSelectModelForRequest:
    ...
    def test_provider_constraint(self):
