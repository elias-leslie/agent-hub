...
from app.adapters._claude_constants import DEFAULT_ALLOWED_CLI_TOOLS, build_allowed_tools


def test_default_allowed_cli_tools_stay_provider_native_rwbe() -> None:
    assert DEFAULT_ALLOWED_CLI_TOOLS == ["Read", "Write", "Bash", "Edit"]
