...
def upgrade() -> None:
    ...
    op.add_column(
        "memory_settings",
        sa.Column("max_mandates", sa.Integer(), server_default="0", nullable=False),
    )
    op.add_column(
        "memory_settings",
        sa.Column("max_guardrails", sa.Integer(), server_default="0", nullable=False),
    )
    op.add_column(
        "memory_settings",
        sa.Column("max_references", sa.Integer(), server_default="0", nullable=False),
    )
