...
async def complete_internal(*args: Any, **kwargs: Any) -> Any:
    from app.api.complete.core import complete_internal as _complete_internal

    return await _complete_internal(*args, **kwargs)
