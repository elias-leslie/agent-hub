...
MODEL_CATALOG: list[ModelEntry] = [
    ...
    ModelEntry(
        ...
        cost=ModelCost(0.50, 2.00), context_window=200_000, speed_tier="medium", timeout_hint_seconds=120.0,
    ...
    ModelEntry(
        ...
        cost=ModelCost(0.00, 0.00), context_window=256_000, speed_tier="medium", timeout_hint_seconds=120.0,
