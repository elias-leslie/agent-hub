...
MODEL_CATALOG: list[ModelEntry] = [
    ...
    ModelEntry(
        ...
        cost=ModelCost(0.00, 0.00), context_window=0, speed_tier="slow",
    ...
    ModelEntry(
        ...
        cost=ModelCost(0.00, 0.00), context_window=0, speed_tier="fast",
        capabilities=ModelCapabilities(can_generate_images=True, max_output_tokens=0),
        release_date="2024-12-01", family="flux",
    ),
    ModelEntry(
    ...
    ModelEntry(
        ...
        cost=ModelCost(0.0035 * 1000, 0.00), context_window=0, speed_tier="fast",
        capabilities=ModelCapabilities(can_generate_images=True, max_output_tokens=0),
