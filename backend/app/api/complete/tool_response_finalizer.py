"""Response finalization for tool execution handlers."""
...
async def finalize_claude_response(
    db: AsyncSession,
    session: DBSession,
    session_id: str,
    is_new_session: bool,
    ...
    """Finalize Claude response with thinking content support.
    ...
    Args:
        ...
        thinking_parts: List of thinking strings
...
async def finalize_gemini_response(
    ...
    """Finalize Gemini response (no thinking content).
