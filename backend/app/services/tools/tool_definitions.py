...
# --- Model configuration tool for persona ---
    ...
    input_schema={
        ...
        "properties": {
            "action": {
                "type": "string",
                "enum": [
                    "list_models", "get_model_details", "update_agent_model",
                    "get_benchmarks", "list_agents",
                ],
...
# --- Agent performance logging tools for persona ---
