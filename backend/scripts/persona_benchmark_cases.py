...
_DISPATCH_READINESS_CASES: list[PersonaBenchmarkCase] = [
    _case(
        ...
        scenario=(
            ...
            "done_when=Serializer has one source of truth, tests updated, st check --quick --changed-only passes.\n"
...
_LIVE_HEARTBEAT_ACCEPTANCE_CASES: list[PersonaBenchmarkCase] = [
    ...
    _case(
        ...
        scenario=(
            ...
            "read_file_result_1='Error: File not found: /home/demo/projects/agent-hub/app/services/heartbeat_data.py'\n"
            "read_file_result_2='Error: File not found: /home/demo/projects/agent-hub/app/services/heartbeat_orchestrator.py'\n"
